    ...
    <div onClick={onClose}
      ...
      <div onClick={e => e.stopPropagation()} style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:20 }}>
        <div style={{ textAlign:'center' }}>
          <div style={{ fontSize:13, fontWeight:700, color:'#0fe3b0', letterSpacing:'0.08em', textTransform:'uppercase', marginBottom:4 }}>Salamtak</div>
...
<body>
  ...
  <div class="footer">
    <div>
      <div>Generated by Salamtak &mdash; ${new Date().toLocaleString()}</div>
