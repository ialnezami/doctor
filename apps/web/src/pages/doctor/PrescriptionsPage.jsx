    ...
    el.innerHTML = `
      ...
      <div style="font-family:Georgia,serif;padding:40px;max-width:600px;margin:0 auto;color:#000">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:13px">
          <thead><tr style="background:#f5f5f5">${['Medication','Dosage','Frequency','Duration'].map(h=>`<th style="border:1px solid #ddd;padding:6px 10px;text-align:left">${h}</th>`).join('')}</tr></thead>
        ...
        ${rx.instructions ? `<div style="margin-top:18px;font-size:13px"><strong>Instructions:</strong> ${rx.instructions}</div>` : ''}
        <div style="margin-top:36px;border-top:1px solid #ccc;padding-top:14px;font-size:11px;color:#555;text-align:center">Generated by MediConnect · Digitally issued and valid without a physical signature.</div>
      </div>`;
          ...
          <div>
            ...
            {rxList.map((rx, i) => (
              <div key={rx._id || i} style={{ display:'flex', alignItems:'center', gap:12, padding:'12px 14px', background:'var(--bg3)', border:'1px solid var(--border)', borderRadius:'var(--r-sm)', marginBottom:8 }}>
                ...
                <Button variant="ghost" style={{ padding:'4px 9px', fontSize:11 }} onClick={() => printRx(rx)}>🖨 Print</Button>
              </div>
            ))}
          </div>
        </div>
